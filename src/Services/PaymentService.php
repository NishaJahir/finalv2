...
class PaymentService
{
    ...
    */
    public function isPaymentActive($basket, $paymentKey)
    {
		...
		$this->getLogger(__METHOD__)->error('country', $paymentAllowedCountry);
		...
		$this->getLogger(__METHOD__)->error('min', $minimumOrderAmount);
		...
		$this->getLogger(__METHOD__)->error('max', $maximumOrderAmount);
        ...
        $this->getLogger(__METHOD__)->error('display', $paymentDisplay);
